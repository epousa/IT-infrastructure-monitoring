...
var app = angular.module('forecast', ['onms.http', 'onms.default.apps']).config(['$locationProvider', function ($locationProvider) {
...
app.controller('forecastCtrl', /* @ngInject */["$scope", function ($scope) {
  ...
  function renderGraph(graphModel, s, e) {
    ...
    var start = s === undefined ? end - 7 * 24 * 60 * 60 * 1000 : s;
...
__webpack_require__(/*! ../../../../../node_modules/flot.saveas/jquery.flot.saveas */ "./node_modules/flot.saveas/jquery.flot.saveas.js");
