...
var mainTemplate = __webpack_require__(/*! ./main.html */ "./src/main/assets/js/apps/onms-elementList/minion-elementList/main.html");
...
// Minion list module
angular.module(MODULE_NAME, ['onms.restResources', 'onms.elementList', 'minionListFilters', 'onmsDateFormatter']).config(['$locationProvider', function ($locationProvider) {
  $locationProvider.hashPrefix('');
}])
