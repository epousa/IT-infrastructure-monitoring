...
(0, _filter.default)(_context = angular.module('onms-ksc-wizard', ['onms.http', 'onms.default.apps', 'ui.bootstrap', 'angular-growl']).config(['$locationProvider', function ($locationProvider) {
      ...
      buttons: {
        reload: {
          ...
          callback: function callback() {
            $http.put('rest/ksc/reloadConfig').then(function () {
